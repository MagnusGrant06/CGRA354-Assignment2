...
See the full and updated list of generators here: https://cmake.org/cmake/help/latest/manual/cmake-generators.7.html#visual-studio-generators
...
Example for more recent versions, Visual Studio 2022, 64-bit systems:
```sh
> cmake -G "Visual Studio 17 2022" -A x64 ..\work
```

and Visual Studio 2026, 64-bit systems:
```sh
> cmake -G "Visual Studio 18 2026" -A x64 ..\work
```
...
Open the generated .xcodeproj file inside the build directory. In the Xcode toolbar, change the scheme dropdown to base, then click the Run button.

Alternatively, you can run the executable from the terminal:
```sh
$ ./build/Debug/base [args..]
```
